...
export default function Button({
  ...
  return (
    <button
      {...props}
      className={clsx(
        "min-h-10 flex flex-row gap-2 w-auto text-sm font-semibold outline-none py-2.5 px-4 rounded-lg transition duration-300",
        ...
        props?.className,
        {
          ...
          "items-center justify-center": isLoadingShort && isLoading,
        }
      )}
      aria-label={ariaLabel}
    >
